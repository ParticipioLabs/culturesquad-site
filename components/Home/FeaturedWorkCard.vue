<template>
  <div
    class="d-flex mb-lg-3 mb-sm-5 border-bottom pb-3 flex-wrap w-100">
    ...
    <div class="col-lg-6 col-sm-12">
      ...
      <div v-html="removeSquareBracketsTag(work.excerpt)"/>
...
<script>
  import {removeSquareBracketsTag} from '../../modules/utils'
